...
val MockMarkets = listOf(
    Market(
        ...
        name = "Sabor Grill",
        description = "Churrascaria com cortes nobres e buffer variado. Experiência completa para os amantes de carne",
        coupons = 10,
//        rules = listOf(
//            Rule("1", "Válido até o dia 25/12", "012576ea-4441-4b8a-89e5-d5f32104c7c4"),
//            Rule("2", "Disponível apenas para consumo local", "012576ea-4441-4b8a-89e5-d5f32104c7c4"),
//            Rule("3", "Disponível apenas para compras acima de R$ 50,00", "012576ea-4441-4b8a-89e5-d5f32104c7c4"),
//            Rule("4", "Válido apenas para o final de semana", "012576ea-4441-4b8a-89e5-d5f32104c7c4")
//        ),
    ...
    Market(
        ...
        categoryId = "2bc11e34-5f30-4ba0-90fa-c1198f649281",
        name = "Café Central",
